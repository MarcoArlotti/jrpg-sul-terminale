...
def magie(giocatore_vivo_,lista_nemici):
    ...
    if battaglia_vinta == True:
        ...
        magia_scelta = int(input(colored("inserire il numero di quale magia scegliere...","grey")))
    ...
    return sp_insufficente,giocatore_vivo_,lista_nemici
